...
public class Main extends JFrame {
     ...
     */
    private Main(String startURL, boolean useOSR, boolean isTransparent, String[] args) throws UnsupportedPlatformException, CefInitializationException, IOException, InterruptedException {
    ...
    public static void main(String[] args) throws UnsupportedPlatformException, CefInitializationException, IOException, InterruptedException {
    	...
    	String localHtmlPath = new java.io.File("src/main/resources/maps/gmaps/index.html").toURI().toString();
    	
    	//browser_.loadURL(resource.toExternalForm());
        
        new Main(localHtmlPath, useOsr, false, args);
    }
}